...
const PRICE = {
  ...
  'tencent/hunyuan-image-3': () => 0.08,
  'minimax/image-01': () => 0.01,
  'black-forest-labs/flux-2-flex': () => 0.06,
  'prunaai/hidream-l1-fast': () => 0.02,
  'leonardoai/lucid-origin': () => 0.04,
  'openai/gpt-image-2': i => (i.quality === 'high' ? 0.19 : 0.06),
  'xai/grok-imagine-image': () => 0.07,
  'aisha-ai-official/anillustrious-v4': () => 0.015,
