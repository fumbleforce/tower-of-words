...
OUT = os.path.join(os.path.dirname(__file__), '..', 'art', 'slice', 'emi2')
...
N = ('worst quality, low quality, early, old, score_1, score_2, score_3, artist name, blurry, jpeg artifacts, bad anatomy, bad hands, '
     ...
     'double chin, wide face, belly, older woman, middle-aged')
BASE = ('Emi, 32, an anime woman from Britain, fair skin, auburn hair, shoulder-length bob, side-swept bangs parted on the left, '
        'warm brown eyes, eyeliner, brown tortoiseshell glasses, slim face, narrow jaw, sharp jawline, adult woman, '
        'slim waist, very large breasts, wide hips, hourglass figure, toned, slender arms')
WORK = 'fitted cream silk blouse with the top button open, charcoal pencil skirt, thin gold chain bracelet, company lanyard'
...
SMILE = 'cheeks lifting into a big smile, small dimples, cute small overbite visible when she smiles, smiling eyes'
EXPR = {
...
for tag, model in MODELS.items():
    ...
    looks = (('work', WORK),) if mode == 'test' else (('work', WORK), ('dress', DRESS))
