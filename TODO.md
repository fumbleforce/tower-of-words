...
- **Locations round 2 (proto2/locations2):** basement office redone from scratch (4 options: doorway, two reverse angles toward the door, one with desks in the middle) and the dorm room (3 options). 10 rejects listed on the page. Staging in tools/locations2.py. RDBT ignores "high corner view" and mostly puts desks along the walls. The dorm views read as about a third floor, not the sixth in the note. Pick, then convert to game/img/bg.
